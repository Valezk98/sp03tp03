...
export async function agregarSuperheroeDashboardController(req, res) {
    try {
        ...
        res.status(201).render('addSuperhero', {superheroe})
...
export async function eliminarSuperheroeDashboardController(req, res){
    try {
        ...
        if(!superheroeBorrado){
            return res.status(404).render('dashboard', { superheroes: await obtenerSuperheroes()})
        }

        res.status(200).render('eliminado', { superheroe: null })
    } catch (error) {
